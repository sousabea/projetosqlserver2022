...
SELECT * FROM [TABELA DE PRODUTOS] WHERE NOT (SABOR = 'Manga' AND TAMANHO = '470 ml');
SELECT * FROM [TABELA DE PRODUTOS] WHERE NOT (SABOR = 'Manga' OR TAMANHO = '470 ml');

SELECT * FROM [TABELA DE PRODUTOS] WHERE SABOR IN ('Manga', 'Laranja', 'Melancia');
SELECT * FROM [TABELA DE PRODUTOS] WHERE (SABOR IN ('Manga', 'Laranja', 'Melancia')) AND TAMANHO = '1 litro';
...
SELECT * FROM [TABELA DE PRODUTOS] WHERE SABOR IN ('Lima/Limao', 'Morango/Limao');

SELECT * FROM [TABELA DE PRODUTOS] WHERE SABOR LIKE '%Limao';
SELECT * FROM [TABELA DE PRODUTOS] WHERE SABOR LIKE '%Maca%';
SELECT * FROM [TABELA DE PRODUTOS] WHERE SABOR LIKE 'Morango%';
SELECT * FROM [TABELA DE PRODUTOS] WHERE (SABOR LIKE 'Morango%') AND (EMBALAGEM = 'PET');